...
const HeroLayout: React.FC<{ 
  ...
  return (
    <div className={`fixed inset-0 pointer-events-none px-12 ${isBg ? 'z-[5]' : 'z-[200]'}`}>
      <div className="absolute bottom-24 left-12 right-12 max-w-4xl">
        ...
        <div className="mb-6 overflow-hidden">
          <motion.div
            ...
            className="flex items-center gap-3 text-current opacity-30 text-[10px] uppercase tracking-[0.4em] font-bold"
          >
        ...
        <div className="max-w-md h-[160px] relative">
          <AnimatePresence>
            {introFinished && (
              <motion.div
                initial={{ opacity: 0, y: 20, filter: 'blur(10px)' }}
              ...
              >
                ...
                >
                  <button className="px-10 py-5 bg-foreground text-background text-[10px] uppercase tracking-[0.2em] font-bold rounded-sm hover:opacity-90 transition-all duration-500 hover:scale-105 active:scale-95">
                    Book a session
                  </button>
                  <button className="text-foreground opacity-40 hover:opacity-100 text-[10px] uppercase tracking-[0.2em] font-bold transition-all duration-500 underline underline-offset-8 decoration-foreground/10 hover:decoration-foreground">
                    View Archive
                  </button>
                </motion.div>
              </motion.div>
      ...
      {/* Featured In Footer */}
      <div className={`fixed bottom-12 right-12 flex items-center gap-8 text-[9px] uppercase tracking-[0.3em] text-current opacity-20 font-bold ${isBg ? 'opacity-0' : ''}`}>
